export default function ServicesHero() {
  return (
    <section className="relative flex flex-col items-center justify-center text-center py-24 sm:py-32 overflow-hidden">
      <div
        className="absolute inset-0 z-0 opacity-20 max-w-full"
        style={{
      ...
      <p className="relative mt-4 max-w-xl text-lg sm:text-xl z-10 text-gray-600 drop-shadow-[0_1px_4px_rgba(0,0,0,0.25)] lg:-top-8">
