    ...
    <div className="relative flex flex-col items-center max-w-screen-xl px-4 mx-auto lg:flex-row sm:px-6 p-4">
      <div className="flex items-center py-5 lg:w-1/2 lg:pb-10 lg:pt-10 lg:pr-4 slide-fade-in">
        <div className="text-center lg:text-left">
          <h2 className="text-4xl font-extrabold leading-tight tracking-tight text-gray-800 sm:text-5xl">
            BERT <span className="text-blue-800">ELECTRIC</span>
          </h2>
          <p className="max-w-md mx-auto mt-3 text-base text-gray-500 leading-relaxed sm:text-lg md:mt-4 md:text-xl md:max-w-3xl">
          ...
          <div className="mt-5 md:mt-6">
            <Link
              to="/rreth-nesh"
              className="inline-flex items-center justify-center px-4 py-2 sm:px-8 sm:py-3 text-base font-semibold text-white transition duration-150 ease-in-out bg-blue-800 rounded-md hover:bg-blue-700 shadow hover:scale-106"
            >
              Mëso më shumë
            </Link>
          </div>
      ...
      <div className="flex items-center py-5 lg:w-2/3 lg:pb-20 lg:pt-10 lg:pl-10 pop-fade-in">
        <div className="relative w-full p-3 rounded lg:p-8">
